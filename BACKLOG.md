...
| Better placeholder when no image found | ⬜ | P2 | S | €0 | Interim: falls back to a location-correct HERE static-map thumbnail. A branded category placeholder would be nicer. |
